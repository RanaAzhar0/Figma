        ...
        <div className="h-[623px] w-[100%] ml-[10rem] ">
          <div className="h-[100%] w-[75%] shadow-lg   flex flex-col items-center">
            <div className="h-10 w-[21rem]    flex  items-center ">
              <div className="h-5 w-5 bg-[#3B3775] text-xs  rounded-full flex items-center justify-center">1</div>
              ...
              <div className="h-[0.5px] w-20 bg-slate-400"></div>
              <div onClick={goOnNext} className="h-5 w-5 bg-slate-400 text-xs rounded-full flex items-center justify-center cursor-pointer">3</div>
              <div className="h-[0.5px] w-20 bg-slate-400"></div>
            ...
            <div className="h-[55vh] w-[40rem]    grid grid-cols-2 gap-4 mt-10">
              <div className="h-20 w-60 ml-16 ">
                <p className="mt-3" >Email<span className="text-[#252525]">*</span></p>
                <input placeholder="email" className=" p-2 rounded h-10 w-60 border border-black" />
              </div>

              <div className="h-20 w-60  ">
                <p className="mt-3" >Home Contact No<span className="text-[#252525]">*</span></p>
                <input placeholder="contact" className=" p-2 rounded  h-10 w-60  border border-black " />
              </div>

              <div className="h-20 w-60 ml-16 ">
                <p className="mt-3" >Mobile<span className="text-[#463535]">*</span></p>
                <input type="no" placeholder="Enter Phone no" className=" p-2 rounded h-10 w-60 border border-black" />
              </div>

              <div className="h-20 w-60  ">
                <p type="text" className="mt-3" >Country<span className="text-[#252525]">*</span></p>
                <input placeholder="" className=" countryp-2 rounded  h-10 w-60 border border-black" />
              </div>
              <div className="h-20 w-60 ml-16  ">
                <p type="text" className="mt-3" >Address Line 1<span className="text-[#252525]">*</span></p>
                <input placeholder="add" className=" p-2 rounded  h-10 w-60 border border-black" />
              </div>
              <div className="h-20 w-60  ">
                <p type="text" className="mt-3" >City<span className="text-[#252525]">*</span></p>
                <input placeholder="city" className=" p-2 rounded  h-10 w-60 border border-black" />
              </div> 
              <div className="h-20 w-60 ml-16  ">
                <p type="text" className="mt-3" >Address Line 2<span className="text-[#252525]">*</span></p>
                <input placeholder="add" className=" p-2 rounded  h-10 w-60 border border-black" />
              </div>
              <div className="h-20 w-60  ">
                <p type="text" className="mt-3" >ZIP Postal Code<span className="text-[#252525]">*</span></p>
                <input placeholder="postal code" className=" p-2 rounded  h-10 w-60 border border-black" />
              </div>
