    ...
    <>
      ...
      <div className="h-[900px] w-[100%]">
        <div className="step1 h-[270px] w-[99.8%]   ml-[0.5px] flex justify-center items-center flex-col">
          <p className="text-white font-extrabold leading-10 text-4xl">Step 1: Basic Information</p>
        ...
        <div className="h-[623px] w-[100%] ml-[10rem] ">
          <div className="h-[100%] w-[75%] shadow-lg   flex flex-col items-center">
            <div className="h-10 w-[21rem]    flex  items-center ">
              ...
              <div onClick={goOnNext} className="h-5 w-5 bg-slate-400 text-xs rounded-full flex items-center justify-center cursor-pointer">2</div>
              <div className="h-[0.5px] w-20 bg-slate-400"></div>
            ...
            <div className="h-[55vh] w-[40rem]    grid grid-cols-2 gap-4 mt-10">
              <div className="h-20 w-60 ml-16 ">
                <p className="mt-3" >First Name<span className="text-[#252525]">*</span></p>
                <input placeholder="Enter Name" className=" p-2 rounded h-10 w-60 border border-black" />
              </div>

              <div className="h-20 w-60  ">
                <p className="mt-3" >Last Name<span className="text-[#252525]">*</span></p>
                <input placeholder="Enter Email" className=" p-2 rounded  h-10 w-60  border border-black " />
              </div>

              <div className="h-20 w-60 ml-16 ">
                <p className="mt-3" >Date of  Birth<span className="text-[#463535]">*</span></p>
                <input type="datetime-local" placeholder="Enter Phone no" className=" p-2 rounded h-10 w-60 border border-black" />
              </div>

              <div className="h-20 w-60  ">
                <p type="text" className="mt-3" >Degree Level<span className="text-[#252525]">*</span></p>
                <input placeholder="Enter Password" className=" p-2 rounded  h-10 w-60 border border-black" />
              </div>
              <div className="h-20 w-60      ml-16 flex  ">
                <p>Gender</p>

                <p className="mt-10" >male</p>
                <input type="radio" className="mt-7   ml-4" />
                <p className="mt-10 ml-4" >female</p>
                <input type="radio" className="mt-7   ml-4" />
              </div>
            </div>
